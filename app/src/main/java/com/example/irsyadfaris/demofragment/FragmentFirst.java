...
public class FragmentFirst extends Fragment {
    ...
    Button buttonAddTextFrag1;
    TextView textViewFrag1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        textViewFrag1 = (TextView) view.findViewById(R.id.tvFrag1);
        buttonAddTextFrag1 = (Button) view.findViewById(R.id.btnAddTextFrag1);

        buttonAddTextFrag1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String data = textViewFrag1.getText().toString() + "\n + New Data";
                textViewFrag1.setText(data);
            }
        });
        return view;
    }
